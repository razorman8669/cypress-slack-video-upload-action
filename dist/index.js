...
function getChannelId(channelName, slackInstance) {
    var _a;
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (['upload', 'finish'].includes(action.toLowerCase()) &&
                previousMsgThreadId === '') {
            ...
            const videos = (0, walk_sync_1.default)(videosDir, { globs: ['**/*.mp4'] });
            const screenshots = (0, walk_sync_1.default)(screenshotsDir, { globs: ['**/*.png'] });
            ...
            core.info(`Found ${videos.length} videos and ${screenshots.length} screenshots`);
